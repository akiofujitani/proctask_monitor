...
class MainView(Frame):
    def __init__(self, master: Tk, *args, **kwargs):
        ...
        self.start_button.grid(column=0, row=0, padx=(3), pady=(3), sticky='nesw')
        Hovertip(self.start_button, 'Printing cicle start.')
        ...
        self.stop_button.grid(column=1, row=0, padx=(3), pady=(3), sticky='nesw')
        Hovertip(self.stop_button, 'Printing cicle stop.')
        ...
        self.config_button.grid(column=3, row=0, padx=(3), pady=(3), sticky='nesw')  
